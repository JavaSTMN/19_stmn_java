        ...
        addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case 'q':
					...
					int rotate1 = (int) (x*Math.cos(8) - y*Math.sin(8));
					spacecraft.setX(rotate1);
					spacecraft.setY(rotate1);
					break;

				case 's' :
				// TODO Fill me
					int x1 = spacecraft.getX();
					int y1 = spacecraft.getY();
					int rotate2 = (int) (x1*Math.cos(-8) - y1*Math.sin(-8));
					spacecraft.setX(rotate2);
					spacecraft.setY(rotate2);
					break;
				}				
			}
		});
